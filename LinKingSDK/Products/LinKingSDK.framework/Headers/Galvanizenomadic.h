...
@class Tyrantamong;
@class Galvanizenomadic;

@protocol GalvanizenomadicDelegate <NSObject>

/**
 Galvanizenomadic after the selection of the callback method
 @param date Select the date
 @param dateString Select the date string
 */
- (void)datePickerController:(nonnull Galvanizenomadic *)datePickerController
...
@interface Galvanizenomadic : UIViewController
 ...
 */
@property (nonnull, strong, nonatomic, readonly) Tyrantamong *datePickerView;
 ...
 */
@property (nullable, weak, nonatomic) id<GalvanizenomadicDelegate> delegate;
