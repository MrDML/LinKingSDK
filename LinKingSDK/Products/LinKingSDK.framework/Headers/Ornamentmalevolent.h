...
@protocol OrnamentmalevolentDelegate <NSObject>


@end

@interface Ornamentmalevolent : NSObject
...
/// 新手引导
- (void)Permeateresourceful:(NSString *)contentId EventServerId:(NSString *)serverId roleId:(NSString *)roleId roleName:(NSString *)roleName complete:(void(^_Nullable)(NSError * _Nullable error))complete;
