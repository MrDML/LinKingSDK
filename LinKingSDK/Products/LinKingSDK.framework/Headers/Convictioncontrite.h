...
@interface Convictioncontrite : Immenselyforecast
...
/// @param content 报错信息
/// @param complete 回调
+ (void)Violationskyline:(NSString *)title conctent:(NSString *)content complete:(void(^_Nullable)(NSError *_Nullableerror))complete;
@end
