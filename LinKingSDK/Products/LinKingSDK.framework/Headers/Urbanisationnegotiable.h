...
/// @param parames 内购参数
/// @param handle 内购完成回调
- (void)Beholdersimplify:(NSString *)purchID parames:(NSDictionary *)parames completeHandle:(INAPPPurchCompletionHandle)handle;
// 查询订阅
