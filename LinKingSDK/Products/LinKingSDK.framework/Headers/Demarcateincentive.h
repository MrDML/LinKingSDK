...
@interface Demarcateincentive : NSObject
...
/// 新手引导
- (void)Yawnzealotry:(NSString *)contentId content:(NSString *)content EventServerId:(NSString *)serverId roleId:(NSString *)roleId roleName:(NSString *)roleName complete:(void(^_Nullable)(NSError * _Nullable error))complete;
...
/// @param complete 回调
- (void)Circularon:(NSString *)serverId roleId:(NSString *)roleId roleName:(NSString *)roleName enterGame:(BOOL)enterGame complete:(void(^_Nullable)(NSError * _Nullable error))complete;

/// 用于追踪付款信息配置状态
/// @param success 是否成功
- (void)Stupendouscue:(BOOL)success;
/// 用于追踪付款信息配置状态
/// @param price 价格
/// @param type 商品类型
/// @param currency 货币类型
...
- (void)Hoarseonerous:(NSNumber *)price orderId:(NSString *)orderId receiptId:(NSString *)receiptId;
...
/// @param currency 货币类型
- (void)Forgetrefined:(NSNumber *)price contentType:(NSString *)contentType contentId:(NSString *)contentId content:(NSString *)content  quantity:(int)quantity payment:(NSString *)payment currency:(NSString *)currency;
...
/// @param desc 描述
/// @param quantity 数量
- (void)Disturbwonderful:(NSNumber *)price type:(NSString *)type currency:(NSString *)currency orderId:(NSString *)orderId desc:(NSString *)desc quantity:(int)quantity;

/// 用于追踪付费订阅购买
/// @param price 价格
- (void)Trustsitting:(NSNumber *)price;

/// 用于追踪产品的免费试用的开始
/// @param price 价格
/// @param currency 货币类型
- (void)Cannibalismprincipal:(NSNumber *)price currency:(NSString *)currency;
...
/// @param content 事件内容
- (void)Undulateairline:(NSNumber *)price ContentType:(NSString *)contentType contentId:(NSString *)contentId content:(NSString *)content;

/// 用于追踪成就解锁事件
/// @param desc 详细描述
- (void)Probablysand:(NSString *)desc;
...
/// @param content 内容描述
/// @param currency 货币类型
- (void)Vexationaffordable:(NSNumber *)price contentType:(NSString *)contentType contentId:(NSString *)contentId content:(NSString *)content currency:(NSString *)currency;

/// 用于追踪列表视图事件
/// @param contentType 列表视图类别
/// @param contentList 列表集合
- (void)Mundaneannually:(NSString *)contentType contentList:(NSArray *)contentList;
...
/// 用于追踪用户登录事件
- (void)Symptomcigaret:(NSString *)style;
...
- (void)Babyboomersergeant:(NSString *)contentId;
