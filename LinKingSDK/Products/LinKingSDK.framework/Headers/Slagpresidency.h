...
@class Bombastictiming;
@class Enervateunbridled;
...
@protocol SlagpresidencyDelegate <NSObject>
...
@interface Slagpresidency : NSObject
@property (nonatomic, assign,readonly) LKPLATFORM platform;
@property (nonatomic, strong,readonly) Bombastictiming *titoManager;
@property (nonatomic, strong,readonly) Enervateunbridled *YLHManager;
@property (nonatomic, weak) id <SlagpresidencyDelegate>delegate;
